...
try:
    ...
    # Fallback for newer mediapipe version
    # We need to install mediapipe-solutions
    print("Installing mediapipe-solutions for compatibility...")
    import subprocess
    import sys
    subprocess.check_call([sys.executable, "-m", "pip", "install", "mediapipe-solutions"])
    from mediapipe import solutions
    mp_hands = solutions.hands
    mp_draw = solutions.drawing_utils
